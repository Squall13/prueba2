...
lib.ssMetadata = [
		{name:"PRUEBA_20ANIMATE_atlas_", frames: [[0,0,276,276]]}
];
...
(lib.CachedTexturedBitmap_2 = function() {
	this.initialize(ss["PRUEBA_20ANIMATE_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(-69,-69,138,138), null);
...
(lib.Sintítulo1 = function(mode,startPosition,loop) {
	...
	this.movieClip_1.setTransform(229.05,239.9);

	this.instance = new lib.CachedTexturedBitmap_2();
	this.instance.parent = this;
	this.instance.setTransform(348,307.9,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.movieClip_1}]}).to({state:[{t:this.instance}]},13).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(560.1,470.9,-74.10000000000002,-25);
// library properties:
lib.properties = {
	id: 'DC278D6140F7C146836184179AAD257C',
	width: 800,
	height: 600,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PRUEBA_20ANIMATE_atlas_.png", id:"PRUEBA_20ANIMATE_atlas_"}
	],
	preloads: []
};
...
an.compositions['DC278D6140F7C146836184179AAD257C'] = {
